...
{
    /// <inheritdoc />
    public partial class newResetMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModuleTasks", x => x.ModuleTaskId);
                    table.ForeignKey(
                        name: "FK_ModuleTasks_Modules_ModuleTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentModules", x => new { x.ModulesModuleID, x.StudentsStudentID });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentModules_Students_StudentsStudentID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ModuleTasksModuleTaskId = table.Column<int>(type: "int", nullable: false),
                    StudentsStudentID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ StudentTasks", x => new { x.ModuleTasksModuleTaskId, x.StudentsStudentID });
                    table.ForeignKey(
                        name: "FK_ StudentTasks_ModuleTasks_ModuleTasksModuleTaskId",
                        column: x => x.ModuleTasksModuleTaskId,
                        principalTable: "ModuleTasks",
                        principalColumn: "ModuleTaskId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ StudentTasks_Students_StudentsStudentID",
                        column: x => x.StudentsStudentID,
                        principalTable: "Students",
                        principalColumn: "StudentID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ StudentTasks_StudentsStudentID",
                table: " StudentTasks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentModules_StudentsStudentID",
